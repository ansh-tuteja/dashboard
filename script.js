...
function move() {
    document.querySelector('.login-box').style.transform = 'translateX(-100%)';
    document.querySelector('.signup-box').style.transform = 'translateX(0)';
}

function moveback() {
    document.querySelector('.login-box').style.transform = 'translateX(0)';
    document.querySelector('.signup-box').style.transform = 'translateX(100%)';
}
